...
private final PaymentService paymentService;
    ...
    public ResponseEntity<Page<PaymentResponse>> listPayments(
        ...
        public ResponseEntity<ResponseMessage<Void>> deletePayment(@PathVariable Long paymentId) {
            paymentService.deletePaymentById(paymentId);
            ResponseMessage<Void> resp = ResponseMessage.<Void>builder()
                    .returnBody(null)
        ...
        @DeleteMapping("/my/{paymentId}")
        public ResponseEntity<ResponseMessage<Void>> deleteMyPayment(@AuthenticationPrincipal UserDetailsImpl principal,
                                                                     @PathVariable Long paymentId) {
            paymentService.deletePaymentForUser(paymentId, principal.getId());
            ResponseMessage<Void> resp = ResponseMessage.<Void>builder()
                    .returnBody(null)
                    .message("Payment deleted successfully.")
                    .httpStatus(HttpStatus.OK)
